...
import { getAllCustomers, getAllDrivers } from "../../service/AccountService";
                    ...
                    <tr key={customer.accountId}>
                      <td className={className}>
                        <div className="flex items-center gap-4">
                          <Avatar src={customer.image} alt={customer.name} size="sm" variant="rounded" />
                          <div>
                            <Typography
                              variant="small"
                              color="blue-gray"
                      ...
                      <td className={className}>
                        <Chip
                          ...
                          value={customer.status ? "online" : "offline"}
